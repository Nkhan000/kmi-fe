...
export default function DashboardSideNavigation() {
  ...
  return (
    <div className="min-h-screen max-h-screen top-0 sticky grid py-6 px-3">
      <div className="min-h-full bg-green-500 rounded-lg">
        <div>
          <LogoWithName size="md" logoColor="white" />
        </div>
        ...
        <ul className="flex flex-col">
          {links.map(({ label, param }, idx) => (
            <li
              ...
              className={`text-xl relative capitalize px-12 py-5 font-semibold text-white ${
                searchParams.get("field") == param ? " text-primary-700 " : ""
