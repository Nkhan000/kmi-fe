function Button({ type = "primary", size = "md", children }) {
  ...
  const btnStyles = {
    ...
    tertiary: `max-w-fit border-2 border-green-400 ease-in duration-200 ${textPadding} rounded-md text-primary-900 text-${size} font-semibold hover:bg-green-400 hover:text-primary-50 transition-all outline-gray-400 outline-offset-4`,
  };
