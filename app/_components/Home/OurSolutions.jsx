...
function OurSolutions() {
  ...
  return (
    <section className="min-h-screen px-20 py-12 flex flex-col gap-20 bg-[linear-gradient(180deg,_rgba(246,255,245,1)_0%,_rgba(195,255,198,0.63)_35%,_rgba(195,255,198,0.63)_100%)] bottom-[2px]">
      <SectionHead
